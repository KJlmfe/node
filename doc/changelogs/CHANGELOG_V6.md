...
* [[`152920f9cf`](https://github.com/nodejs/node/commit/152920f9cf)] - really rough start at it (Myles Borins)
* [[`712a953060`](https://github.com/nodejs/node/commit/712a953060)] - **benchmark**: fix typo in inspect-proxy (Vse Mozhet Byt) [#14237](https://github.com/nodejs/node/pull/14237)
* [[`1ac436f31e`](https://github.com/nodejs/node/commit/1ac436f31e)] - **buffer**: remove a wrongly added attribute specifier (Jiajie Hu) [#14466](https://github.com/nodejs/node/pull/14466)
* [[`02a4377d2b`](https://github.com/nodejs/node/commit/02a4377d2b)] - **build**: codesign tarball binary on macOS (Evan Lucas) [#14179](https://github.com/nodejs/node/pull/14179)
...
* [[`e2318b6fc1`](https://github.com/nodejs/node/commit/e2318b6fc1)] - **build,tools**: do not force codesign prefix (Evan Lucas) [#14179](https://github.com/nodejs/node/pull/14179)
...
* [[`75b4e30687`](https://github.com/nodejs/node/commit/75b4e30687)] - **deps**: cherry-pick 18ea996 from c-ares upstream (Anna Henningsen) [#13883](https://github.com/nodejs/node/pull/13883)
...
* [[`22fa484036`](https://github.com/nodejs/node/commit/22fa484036)] - **doc**: add gabrielschulhof to collaborators (Gabriel Schulhof) [#14692](https://github.com/nodejs/node/pull/14692)
* [[`431f9074ba`](https://github.com/nodejs/node/commit/431f9074ba)] - **doc**: update experimental status to reflect use (James M Snell) [#12723](https://github.com/nodejs/node/pull/12723)
* [[`11d1004641`](https://github.com/nodejs/node/commit/11d1004641)] - **doc**: describe labelling process for backports (Anna Henningsen) [#12431](https://github.com/nodejs/node/pull/12431)
* [[`c492df273d`](https://github.com/nodejs/node/commit/c492df273d)] - **doc**: add XadillaX to collaborators (XadillaX) [#14388](https://github.com/nodejs/node/pull/14388)
* [[`af5db3982d`](https://github.com/nodejs/node/commit/af5db3982d)] - **doc**: replace dead link in v8 module (Devin Boyer) [#14372](https://github.com/nodejs/node/pull/14372)
* [[`f766d35c1a`](https://github.com/nodejs/node/commit/f766d35c1a)] - **doc**: move LTS README link to increase prominence (Gibson Fahnestock) [#14259](https://github.com/nodejs/node/pull/14259)
* [[`7bf6f24b65`](https://github.com/nodejs/node/commit/7bf6f24b65)] - **doc**: update umask for clarity (James Sumners) [#14170](https://github.com/nodejs/node/pull/14170)
...
* [[`9cf46f2ca3`](https://github.com/nodejs/node/commit/9cf46f2ca3)] - **doc,stream**: _transform happens one at a time (Matteo Collina) [#14321](https://github.com/nodejs/node/pull/14321)
...
* [[`c6c6ebe1c0`](https://github.com/nodejs/node/commit/c6c6ebe1c0)] - **docs**: add note about fs.rmdir() (Oleksandr Kushchak) [#14323](https://github.com/nodejs/node/pull/14323)
* [[`a2f203802d`](https://github.com/nodejs/node/commit/a2f203802d)] - **gyp**: implement LD/LDXX for ninja and FIPS (Sam Roberts)
* [[`0230a35475`](https://github.com/nodejs/node/commit/0230a35475)] - **http**: OutgoingMessage change writable after end (Roee Kasher) [#14024](https://github.com/nodejs/node/pull/14024)
...
* [[`0b0e06e0f9`](https://github.com/nodejs/node/commit/0b0e06e0f9)] - **linkedlist**: correct grammar in comments (alexbostock) [#14546](https://github.com/nodejs/node/pull/14546)
...
* [[`08e754516d`](https://github.com/nodejs/node/commit/08e754516d)] - **src**: use existing strings over creating new ones (Anna Henningsen) [#14587](https://github.com/nodejs/node/pull/14587)
...
* [[`9c59f1cb00`](https://github.com/nodejs/node/commit/9c59f1cb00)] - **test**: refactor test-domain-abort-on-uncaught (Rich Trott) [#14541](https://github.com/nodejs/node/pull/14541)
* [[`fdc61ced9d`](https://github.com/nodejs/node/commit/fdc61ced9d)] - **test**: refactor test-vm-new-script-new-context (Rich Trott) [#14536](https://github.com/nodejs/node/pull/14536)
* [[`ba89673d39`](https://github.com/nodejs/node/commit/ba89673d39)] - **test**: add check on an addon that does not register (Ezequiel Garcia) [#13954](https://github.com/nodejs/node/pull/13954)
* [[`667a1dba16`](https://github.com/nodejs/node/commit/667a1dba16)] - **test**: improve error logging for inspector test (Rich Trott) [#14508](https://github.com/nodejs/node/pull/14508)
* [[`2a094c540f`](https://github.com/nodejs/node/commit/2a094c540f)] - **test**: fix flaky test-force-repl (Rich Trott) [#14439](https://github.com/nodejs/node/pull/14439)
* [[`90da435342`](https://github.com/nodejs/node/commit/90da435342)] - **test**: replace concatenation with template literal (rockcoder23) [#14270](https://github.com/nodejs/node/pull/14270)
* [[`fb6df52649`](https://github.com/nodejs/node/commit/fb6df52649)] - **test**: replace concatenation with template literal (Ching Hsu) [#14284](https://github.com/nodejs/node/pull/14284)
* [[`742ff24bf5`](https://github.com/nodejs/node/commit/742ff24bf5)] - **test**: replace concatenation with template literals (Zongmin Lei) [#14298](https://github.com/nodejs/node/pull/14298)
* [[`61d188514e`](https://github.com/nodejs/node/commit/61d188514e)] - **test**: replace string concatenation with template (ziyun) [#14286](https://github.com/nodejs/node/pull/14286)
* [[`c1dee467aa`](https://github.com/nodejs/node/commit/c1dee467aa)] - **test**: use path.join for long path concatenation (zzz) [#14280](https://github.com/nodejs/node/pull/14280)
* [[`d799019cbb`](https://github.com/nodejs/node/commit/d799019cbb)] - **test**: replace concatenation with template literals (SkyAo) [#14296](https://github.com/nodejs/node/pull/14296)
* [[`27535a6320`](https://github.com/nodejs/node/commit/27535a6320)] - **test**: fix error handling test-http-full-response (Rich Trott) [#14252](https://github.com/nodejs/node/pull/14252)
* [[`94181d1e01`](https://github.com/nodejs/node/commit/94181d1e01)] - **test**: use regex error check in test-crypto-random (Zhang Weijie) [#14273](https://github.com/nodejs/node/pull/14273)
* [[`d73735ba70`](https://github.com/nodejs/node/commit/d73735ba70)] - **test**: check error with regex in test-signal-safety (shaman) [#14285](https://github.com/nodejs/node/pull/14285)
* [[`04ed1865bf`](https://github.com/nodejs/node/commit/04ed1865bf)] - **test**: use regex error checks in test-util-format (Superwoods) [#14299](https://github.com/nodejs/node/pull/14299)
* [[`a96c000eb2`](https://github.com/nodejs/node/commit/a96c000eb2)] - **test**: use template literal for string concat (tobewhatwewant) [#14288](https://github.com/nodejs/node/pull/14288)
* [[`78efbd0352`](https://github.com/nodejs/node/commit/78efbd0352)] - **test**: simplify string concatenation (jiangplus) [#14278](https://github.com/nodejs/node/pull/14278)
* [[`8a3c1134bc`](https://github.com/nodejs/node/commit/8a3c1134bc)] - **test**: use regexp to confir error message (Bang Wu) [#14268](https://github.com/nodejs/node/pull/14268)
* [[`8c41325234`](https://github.com/nodejs/node/commit/8c41325234)] - **test**: use regluar expression in vm test (akira.xue) [#14266](https://github.com/nodejs/node/pull/14266)
* [[`8b27a8237b`](https://github.com/nodejs/node/commit/8b27a8237b)] - **test**: use regular expression to match error msg (Flandre) [#14265](https://github.com/nodejs/node/pull/14265)
* [[`2014c7f47d`](https://github.com/nodejs/node/commit/2014c7f47d)] - **test**: check complete error message (Fraser Xu) [#14264](https://github.com/nodejs/node/pull/14264)
* [[`ab443f5914`](https://github.com/nodejs/node/commit/ab443f5914)] - **test**: fix flaky test-net-can-reset-timeout (Rich Trott) [#14257](https://github.com/nodejs/node/pull/14257)
...
* [[`0c0d782923`](https://github.com/nodejs/node/commit/0c0d782923)] - **tools**: update to ESLint 4.3.0 (Rich Trott) [#14417](https://github.com/nodejs/node/pull/14417)
* [[`439f3da5b0`](https://github.com/nodejs/node/commit/439f3da5b0)] - **tools**: update package.json `engine` field (AJ Jordan) [#14165](https://github.com/nodejs/node/pull/14165)
* [[`80029b43ee`](https://github.com/nodejs/node/commit/80029b43ee)] - **tools**: update ESLint to 4.2.0 (Rich Trott) [#14155](https://github.com/nodejs/node/pull/14155)
